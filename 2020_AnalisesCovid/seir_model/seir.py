...
def prepare_states(population_params, place_specific_params, disease_params):
    ...
    exposed = (
        population_params["I"] * place_specific_params["i1_percentage"] * e_perc
    )
...
def prepare_disease_params(population_params, place_specific_params, disease_params, reproduction_rate):
    """
    ...
    parameters = {
        ...
        "gamma1": place_specific_params["i1_percentage"] / disease_params["mild_duration"],
        "p1": (1 - place_specific_params["i1_percentage"]) / disease_params["mild_duration"],
...
def entrypoint(
    ...
    if initial:  # Get I1, I2, I3 & E
        population_params, disease_params = (
            ...
            prepare_disease_params(population_params, place_specific_params, disease_params, phase["R0"]),
        )
    else:
        disease_params = prepare_disease_params(population_params, place_specific_params, disease_params, phase["R0"])
